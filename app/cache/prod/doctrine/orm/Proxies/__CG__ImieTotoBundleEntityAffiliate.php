 ...
 */
class Affiliate extends \Imie\TotoBundle\Entity\Affiliate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'url', 'email', 'token', 'isActive', 'createdAt', 'categories');
        }
